...
HIST_ACC_PNG = os.path.join(DESKTOP_DIR, "densenet121_history_acc.png")
HIST_LOSS_PNG= os.path.join(DESKTOP_DIR, "densenet121_history_loss.png")
CM_PNG       = os.path.join(DESKTOP_DIR, "densenet121_confusion_matrix.png")
