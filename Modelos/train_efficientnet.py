...
HIST_ACC_PNG = os.path.join(DESKTOP_DIR, "efficientnet_b0_history_acc.png")
HIST_LOSS_PNG= os.path.join(DESKTOP_DIR, "efficientnet_b0_history_loss.png")
CM_PNG       = os.path.join(DESKTOP_DIR, "efficientnet_b0_confusion_matrix.png")
